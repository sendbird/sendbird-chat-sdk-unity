...
namespace Sendbird.Chat
{
    internal class UnityHttpClient : IHttpClient
    {
        ...
        void IHttpClient.SetHost(string inHostUrl)
        {
            _host = inHostUrl;
        }
        ...
        void IHttpClient.Request(HttpClientRequestParamsBase inRequestParams)
        {
            CoroutineManager.Instance.StartCoroutine(RequestCoroutine(inRequestParams));
        }

        void IHttpClient.AbortIfRequesting()
        {
