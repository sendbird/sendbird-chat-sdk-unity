...
{
    public partial class SbMutedUserListQuery
    {
        ...
        internal SbMutedUserListQuery(SbChannelType inChannelType, string inChannelUrl, SbMutedUserListQueryParams inQueryParams, SendbirdChatMainContext inChatMainContext)
        {
        ...
        private void LoadNextPageInternal(SbUserListHandler inCompletionHandler)
        {
            ...
            void OnResponse(ApiCommandAbstract.Response inResponse, SbError inError, bool inIsCanceled)
            {
                ...
                if (inError != null || !(inResponse is MutedUserListQueryApiCommand.Response queryResponse))
                {
            ...
            MutedUserListQueryApiCommand.Request request = new MutedUserListQueryApiCommand.Request(_token, _limit, _channelType, _channelUrl, OnResponse);
